  ...
  return (
    <div className="slider">
      ...
      <div className="text-overlay">
        <h1 className='text-with-blur-background' data-aos="fade-down-left"> {t(`Slider.slide${currentSlide + 1}.0`)}</h1>
        <p className='text-with-blur-background'data-aos="flip-left"> {t(`Slider.slide${currentSlide + 1}.1`)}</p>
      </div>
